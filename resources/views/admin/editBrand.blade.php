                        ...
                        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 25px 30px; border-radius: 10px; box-shadow: 0 4px 15px rgba(102, 126, 234, 0.3);">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    ...
                                    <p style="margin: 8px 0 0 0; color: rgba(255,255,255,0.9); font-size: 14px;">{{$Client->name}}</p>
                                </div>
                            ...
                            <form class="form-horizontal" method="post" action="{{url('/admin/edit_Brand')}}/{{$Client->id}}" enctype="multipart/form-data">
                                ...
                                <div style="border-bottom: 2px solid #f0f0f0; padding-bottom: 25px; margin-bottom: 30px;">
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="text1" name="name" value="{{$Client->name}}" placeholder="e.g Sony" class="form-control" style="border-radius: 6px; border: 1px solid #ddd; padding: 10px 15px; transition: all 0.3s;" />
                                            ...
                                            <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; border: 2px dashed #ddd; text-align: center;">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 100%; height: 200px; background: white; border-radius: 6px; overflow: hidden; border: 1px solid #ddd;">
                                                        <img src="{{url('/')}}/uploads/brands/{{$Client->image}}" alt="" style="width: 100%; height: 100%; object-fit: cover;" />
                                                    </div>
