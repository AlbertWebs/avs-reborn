                            ...
                            <form class="form-horizontal" method="post" action="{{url('/admin/edit_Category')}}/{{$Category->id}}" enctype="multipart/form-data">
                                ...
                                <div style="border-bottom: 2px solid #f0f0f0; padding-bottom: 25px; margin-bottom: 30px;">
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="slung" name="slung" value="{{$Category->slung}}" placeholder="e.g car-speakers" class="form-control" style="border-radius: 6px; border: 1px solid #ddd; padding: 10px 15px; transition: all 0.3s;" />
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label for="order" class="control-label col-lg-4" style="font-weight: 600; color: #333; padding-top: 10px;">
                                            Display Order
                                        </label>
                                        <div class="col-lg-8">
                                            <input type="number" id="order" name="order" value="{{$Category->order}}" placeholder="e.g 1" class="form-control" style="border-radius: 6px; border: 1px solid #ddd; padding: 10px 15px; transition: all 0.3s;" />
                                            <small class="help-block" style="color: #666; margin-top: 5px;"><i class="icon-info-sign"></i> Lower numbers appear first</small>
                                        </div>
                                    </div>
